...
import { EventSourcesList } from "@/components/event-sources/event-sources-list";
import { CreateEventSourceDialog } from "@/components/event-sources/create-event-source-dialog";
      ...
      <div className="mt-6 flex items-center justify-between">
        <div>
          ...
          <p className="mt-2 text-sm text-zinc-500">
            Manage data collection sources for {project.name}
          </p>
        </div>
