...
import { ArrowUpRight, Archive, Boxes, MoreHorizontal } from "lucide-react";
      ...
      <div className="relative">
        <div className="flex items-start justify-between">
          <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-zinc-950 text-white shadow-lg shadow-zinc-900/20">
            {isActive ? <Boxes size={20} /> : <Archive size={20} />}
          </div>
          <button
            type="button"
            onClick={(event) => {
        ...
        <div className="mt-8">
          ...
          <p className="mt-2 text-xs font-medium uppercase tracking-wider text-violet-600">
            {project.slug}
          </p>
